...
/***/ "./resources/js/pages/image/resize/ControlSettings.js":
/*!************************************************************!*\
  !*** ./resources/js/pages/image/resize/ControlSettings.js ***!
  \************************************************************/
...
/***/ "./resources/js/pages/image/resize/ImageElement.js":
/*!*********************************************************!*\
  !*** ./resources/js/pages/image/resize/ImageElement.js ***!
  \*********************************************************/
/*! exports provided: ON_ROTATE, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ON_ROTATE", function() { return ON_ROTATE; });
...
var ImageElement = /*#__PURE__*/function (_Observer) {
  ...
  function ImageElement(fileName, file) {
    ...
    _defineProperty(_assertThisInitialized(_this), "extension", null);

    _defineProperty(_assertThisInitialized(_this), "url", null);

    var fileNameData = fileName.split('.');
    _this.fileName = fileNameData[0];
    _this.extension = fileNameData[1];
    _this.file = file;
  ...
  _createClass(ImageElement, [{
    ...
    value: function getFullFileName() {
      return "".concat(this.fileName, ".").concat(this.extension);
    }
  }, {
    key: "getId",
...
/***/ "./resources/js/pages/image/resize/ImageList.js":
/*!******************************************************!*\
  !*** ./resources/js/pages/image/resize/ImageList.js ***!
  \******************************************************/
/*! exports provided: ON_REMOVE_IMAGE, ON_ADD_IMAGE, ON_ACTIVE_IMAGE, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ON_ACTIVE_IMAGE", function() { return ON_ACTIVE_IMAGE; });
/* harmony import */ var _utils_Observer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../utils/Observer */ "./resources/js/utils/Observer.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var ON_ACTIVE_IMAGE = 'active-image';
...
var ImageList = /*#__PURE__*/function (_Observer) {
  ...
  function ImageList() {
    ...
    _defineProperty(_assertThisInitialized(_this), "activeImage", null);
  ...
  _createClass(ImageList, [{
    ...
    key: "isActiveImage",
    value: function isActiveImage(image) {
...
/***/ "./resources/js/pages/image/resize/resize.js":
/*!***************************************************!*\
  !*** ./resources/js/pages/image/resize/resize.js ***!
  \***************************************************/
/*! no exports provided */
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _ImageElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ImageElement */ "./resources/js/pages/image/resize/ImageElement.js");
/* harmony import */ var _ImageList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ImageList */ "./resources/js/pages/image/resize/ImageList.js");
/* harmony import */ var _ControlSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ControlSettings */ "./resources/js/pages/image/resize/ControlSettings.js");
/* harmony import */ var _templates_card_image__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./templates/card-image */ "./resources/js/pages/image/resize/templates/card-image.js");
...
(function () {
  var imageList = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#image-list'),
      uploadInput = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#upload_input'),
      ...
      buttonsIntoContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.content button'),
      controlNavbar = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navbar-left'),
      downloadButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#download');
  var controlSettings = new _ControlSettings__WEBPACK_IMPORTED_MODULE_3__["default"](controlNavbar);
  controlSettings.on(_ControlSettings__WEBPACK_IMPORTED_MODULE_3__["ON_CHANGE_INPUTS"], function (event) {
    var image = _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].getActiveImage();

    var size = _objectSpread(_objectSpread({}, image.getSize()), {}, _defineProperty({}, event.action, event.value));

    image.setSize(size.width, size.height);
    var imageElement = imageList.find("[data-id=\"".concat(image.getId(), "\"]"));
    imageElement.find('.badge-success').text("".concat(image.width, "x").concat(image.height));
  });
  var resizePage = {
    init: function init() {
      var _this = this;
    ...
    loadFiles: function loadFiles(event) {
      ...
      files.forEach(function (file) {
        var promise = new Promise(function (resolve, reject) {
          var image = new _ImageElement__WEBPACK_IMPORTED_MODULE_1__["default"](file.name, file);
      ...
      Promise.all(promises).then(function (res) {
        res.forEach(function (image) {
          return _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].addImage(image);
        });
        _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].setActiveImage(_ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].getFirstImage());
      });
    ...
    addImageCard: function addImageCard(image) {
      var cardClone = jquery__WEBPACK_IMPORTED_MODULE_0___default()(Object(_templates_card_image__WEBPACK_IMPORTED_MODULE_4__["default"])(image));
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.action .delete-card', cardClone).click(function () {
        return _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].removeImage(image);
      });
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(cardClone).click(function () {
        return _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].setActiveImage(image);
      });
      imageList.append(cardClone);
    },
    removeImageCard: function removeImageCard(image) {
      imageList.find("[data-id=\"".concat(image.getId(), "\"]")).remove();

      if (!_ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].images.length) {
        this.toggleSections();
      }

      if (_ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].isActiveImage(image)) {
        _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].setActiveImage(_ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].getFirstImage());
      }
    },
    activeImageCard: function activeImageCard(image) {
      imageList.find('.card.active').removeClass('active');
      imageList.find("[data-id=\"".concat(image.getId(), "\"]")).find('.card').addClass('active');
      controlSettings.setInputData(image.getSize());
    },
    onPushImage: function onPushImage() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].images.forEach(function (image, index) {
                  formData.append("images[".concat(index, "][width]"), image.width);
                  formData.append("images[".concat(index, "][height]"), image.height);
                  formData.append("images[".concat(index, "][file]"), image.file);
                });
                _context.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_5___default.a.post('/image/resize/resizing', formData);
  ...
  _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].on(_ImageList__WEBPACK_IMPORTED_MODULE_2__["ON_ADD_IMAGE"], function (image) {
    return resizePage.addImageCard(image);
  });
  _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].on(_ImageList__WEBPACK_IMPORTED_MODULE_2__["ON_REMOVE_IMAGE"], function (image) {
    return resizePage.removeImageCard(image);
  });
  _ImageList__WEBPACK_IMPORTED_MODULE_2__["default"].on(_ImageList__WEBPACK_IMPORTED_MODULE_2__["ON_ACTIVE_IMAGE"], function (image) {
    return resizePage.activeImageCard(image);
  });
...
/***/ "./resources/js/pages/image/resize/templates/card-image.js":
/*!*****************************************************************!*\
  !*** ./resources/js/pages/image/resize/templates/card-image.js ***!
  \*****************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getCardImage; });
function getCardImage(image) {
  return "<div class=\"col mb-3 d-flex justify-content-center\" data-id=\"".concat(image.getId(), "\">\n        <div class=\"card\" style=\"width: 18rem;\">\n            <img src=\"").concat(image.getUrl(), "\">\n            <div class=\"card-body\">\n                <p>").concat(image.getFullFileName(), "</p>\n                <div class=\"input-group d-none\">\n                    <input type=\"text\" class=\"form-control\" placeholder=\"\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0444\u0430\u0439\u043B\u0430\" required value=\"").concat(image.getFileName(), "\">\n                </div>\n                <div class=\"size\">\n                    <span class=\"badge badge-primary\">").concat(image.width, "x").concat(image.height, "</span>\n                    <b>-></b>\n                    <span class=\"badge badge-success\">").concat(image.width, "x").concat(image.height, "</span>\n                </div>\n            </div>\n            <div class=\"action\">\n                <button type=\"button\" class=\"btn btn-outline-danger btn-sm delete-card\">\n                    <i class=\"fa fa-times\" aria-hidden=\"true\"></i>\n                </button>\n            </div>\n        </div>\n    </div>");
}
...
/***/ 7:
/*!*********************************************************!*\
  !*** multi ./resources/js/pages/image/resize/resize.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/resources/js/pages/image/resize/resize.js */"./resources/js/pages/image/resize/resize.js");
