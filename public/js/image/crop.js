  ...
  _createClass(ControlSettings, [{
    ...
    value: function _initInputs() {
      ...
      this.$elementBox.find('input').on('input', function (event) {
        var _event$currentTarget, _event$currentTarget2, _event$currentTarget3;

        return _this2.dispatch(ON_CHANGE_INPUTS, {
          event: event,
          value: Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_1__["getTypeByInputType"])(event.currentTarget.type, (_event$currentTarget = event.currentTarget) === null || _event$currentTarget === void 0 ? void 0 : _event$currentTarget.value),
          action: (_event$currentTarget2 = event.currentTarget) === null || _event$currentTarget2 === void 0 ? void 0 : (_event$currentTarget3 = _event$currentTarget2.dataset) === null || _event$currentTarget3 === void 0 ? void 0 : _event$currentTarget3.action
        });
      });
    }
  }, {
    ...
    value: function setInputData() {
      ...
      Object.keys(data).forEach(function (key) {
        _this3.$elementBox.find("[name=\"".concat(key, "\"]")).val(data[key]);
      });
    }
  }]);
...
(function () {
  ...
  controlSettings.on(_ControlSettings__WEBPACK_IMPORTED_MODULE_2__["ON_CHANGE_INPUTS"], function (event) {
    cropperImage.setCropBoxData(_defineProperty({}, event.action, event.value));
  });
  cropperImage.on(_CropperImage__WEBPACK_IMPORTED_MODULE_1__["ON_CROP_MOVE"], function () {
    var _cropperImage$getCrop = cropperImage.getCropBoxData(),
        width = _cropperImage$getCrop.width,
        height = _cropperImage$getCrop.height,
        top = _cropperImage$getCrop.top,
        left = _cropperImage$getCrop.left;

    controlSettings.setInputData({
      width: width,
      height: height,
      y: top,
      x: left
  ...
  cropperImage.on(_CropperImage__WEBPACK_IMPORTED_MODULE_1__["ON_READY_CROPPER"], function () {
    var _cropperImage$getCrop2 = cropperImage.getCropBoxData(),
        width = _cropperImage$getCrop2.width,
        height = _cropperImage$getCrop2.height,
        top = _cropperImage$getCrop2.top,
        left = _cropperImage$getCrop2.left;
  ...
  var cropPage = {
    ...
    onPushImages: function onPushImages(event) {
      console.log(_ImageList__WEBPACK_IMPORTED_MODULE_3__["default"]);
    },
    initOnClickSlide: function initOnClickSlide() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('li', splideList).on('click', function () {
        ...
        cropperImage.setImage(_ImageList__WEBPACK_IMPORTED_MODULE_3__["default"].getImageById(imageId));
      });
    },
